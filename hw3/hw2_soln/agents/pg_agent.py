...
class PGAgent(BaseAgent):
    ...
    def train(self, observations, actions, rewards_list, next_observations, terminals):
        ...
        # update the policy using q_values/advantages
    ...
    def calculate_q_vals(self, rewards_list):
        ...
        if not self.reward_to_go:
            # full trajectory return for each step
            for rewards in rewards_list:
                q_values.extend([self._discounted_return(rewards)] * len(rewards))
        else:
            # reward-to-go return
            for rewards in rewards_list:
    ...
    def estimate_advantage(self, obs, rewards_list, q_values, terminals):
        ...
        if self.nn_baseline:
            ...
            # unnormalize to match q_values distribution
    ...
    def _discounted_return(self, rewards):
        ...
        discounted_returns = discounted_sum
